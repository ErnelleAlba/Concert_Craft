  ...
  return (
    <>
      <div className="d-flex flex-wrap ms-0 col-md-4 col-lg-4 col-xl-2 ">
        <div
          className="d-flex align-items-center flex-column justify-content-between bg-dark w-100 px-2 px-md-4 px-lg-4"
        ...
        >
            ...
            <ul className="nav nav-pills flex-column mt-4 gap-4">
              <li className="nav-item py-1 py-sm-0">
                <NavLink
                  ...
                  to="/admin/dashboard"
                >
                  <i className="bi bi-speedometer2 me-0 me-md-3 me-lg-3"></i>
                  <span className="d-md-inline d-none">Dashboard</span>
                </NavLink>
              </li>
              <li className="nav-item py-1 py-sm-0">
                <NavLink
                  ...
                  to="/admin/bookings"
                >
                  <i className="fa-solid fa-ticket me-0 me-md-3 me-lg-3"></i>
                  <span className="d-md-inline d-none">Bookings List</span>
                </NavLink>
              </li>
              <li className="nav-item py-1 py-sm-0">
                <NavLink
                  ...
                  to="/admin/concerts"
                >
                  <i className="fa-solid fa-music me-0 me-md-3 me-lg-3"></i>
                  <span className="d-md-inline d-none">Concerts List</span>
                </NavLink>
              </li>
              <li className="nav-item py-1 py-sm-0">
                <NavLink
                  ...
                  to="/admin/users"
                >
                  <i className="fa-solid fa-user ms-1 me-0 me-md-3 me-lg-3"></i>
                  <span className="d-md-inline d-none">Users List</span>
                </NavLink>
              </li>
            </ul>
          </div>
          ...
          <div className="nav-item py-1 py-sm-0 mb-5 w-100 logout-btn">
            <Link
              ...
              to="/admin"
            >
              <i className="fa-solid fa-right-from-bracket me-0 me-md-3 me-lg-3"></i>
              <span className="d-md-inline d-none">Log Out</span>
            </Link>
          </div>
        </div>
      </div>
